    ...
    <Body style={main}>
      ...
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={paragraph}>
            Here is your automated morning checklist. You have <strong>{choreTitles.length}</strong> assigned tasks due today:
          </Text>
          ...
          <Text style={paragraph}>
            Please check them off in your dashboard interface once they are completed so the shared tracker stays accurate.
          </Text>
